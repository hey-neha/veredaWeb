...
const Fueling = () => {
  return (
    /*    mt-20 */
    <div className="bg-gray-100 w-full h-auto flex flex-col pb-5 md:pb-16 lg:pb-20 items-center text-center px-4">
      <div>
        ...
        <p
          ...
          md:px-36 lg:px-72
         font-light   mt-4 sm:mt-5 md:mt-5 lg:mt-7 mb-5 md:mb-6 lg:mb-8  sm:text-lg md:text-xl"
        >
