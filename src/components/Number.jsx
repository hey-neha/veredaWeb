      ...
      <div className="bg-white  text-[#061C3D] flex flex-col gap-20 w-full ">
        <div className="md:flex md:justify-evenly mx-20 mt-12 mb-8">
          <div className="md:flex md:flex-col text-center gap-3">
            <p className=" md:text-[40px]  leading-tight ">1000+</p>
            <p className="md:px-2 md:text-[15px] font-bold">
          ...
          <div className="md:flex md:flex-col text-center gap-3">
            ...
            <p className="md:px-2 md:text-[15px] font-bold">Client Served</p>
          </div>
          ...
          <div className="md:flex md:flex-col text-center gap-3">
            ...
            <p className="md:px-2 md:text-[15px] font-bold">Awards Won</p>
          </div>
